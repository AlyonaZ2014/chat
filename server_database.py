...
class ServerStorage:
    ...
    def __init__(self):
        ...
        registry.map_imperatively(self.AllUsers, users_table, 6)
        registry.map_imperatively(self.ActiveUsers, active_users_table, 6)
        registry.map_imperatively(self.LoginHistory, user_login_history, 6)
